...
CSV.foreach(csv_file_path, headers: true) do |row|
  ...
  category_id = 1
  category_id = 2 if ["gallica", "damask", "centifolia", "moss", "portland", "alba", "rambler", "bourbon", "hybrid perpetual", "noisette", "china", "tea"].include?(cultivar_group_name)
  category_id = 3 if ["found", "wild", "species"].include?(cultivar_group_name)
...
old_garden_names = ["Alba", "Bourbon", "Centifolia", "China", "Damask", "Gallica", "Hybrid Perpetual", "Moss", "Noisette", "Portland", "Tea"]
